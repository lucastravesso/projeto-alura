...
controle.forEach((e) => {
    e.addEventListener("click", (element) => {
        ...
        const check = element.target.parentNode.querySelector("[data-counter]")
        if (check.value == "00") {return } else {
            atualizaEstatisticas(element.target.dataset.controle, element.target.dataset.peca)
        }
    })
})
